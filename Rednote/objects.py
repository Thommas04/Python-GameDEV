...
class InteractiveObject(Entity):
    def __init__(self, player, x, y, tag, scale = (1, 1, 0), lit = False):
        ...
        if tag == 'lamp_post':
            self.object = Entity(tag = tag, texture = lamp_post_sheet, model = 'quad', position = (x, y, -0.13), origin = (0,-0.5), scale = (1.2, 5.2, 0), alpha = 1, tileset_size = [2,1], tile_coordinate = [0,0])
...
def place_buildings(player):
    ...
    tent_obj_roof = Entity(model='quad', position=(34, 102, -0.17), scale=(7, 3.5, 0), texture=tent_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    ...
    church_obj_roof = Entity(model = 'quad', position = (82, 195, -0.17), scale = (22, 11, 0), texture = church_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    ...
    saloon_obj_roof = Entity(model = 'quad', position = (128.8,130.8, -0.17), scale = (24, 12, 0), texture = saloon_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    saloon_obj_tree = Entity(model = 'quad', position = (128.8,126.8, -0.17), scale = (24, 24, 0), texture = saloon_texture_extended)
    ...
    sheriff_obj_roof = Entity(model='quad', position=(123.9, 107.7, -0.17), scale=(18, 7, 0), texture=sheriff_texture, tileset_size=[1, 2], tile_coordinate=[0, 1])
    ...
    bank_obj_roof = Entity(model = 'quad', position = (157.0,106.7, -0.17), scale = (16, 8, 0), texture = bank_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    ...
    house2_obj_roof = Entity(model = 'quad', position = (40.7,198.3, -0.17), scale = (16, 8, 0), texture = house2_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    ...
    house1_obj_roof = Entity(model = 'quad', position = (130.2,150.6, -0.17), scale = (15, 7.5, 0), texture = house1_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    ...
    shop_obj_roof = Entity(model = 'quad', position = (75.1,152.8, -0.17), scale = (20, 10, 0), texture = shop_texture, tileset_size = [1,2], tile_coordinate = [0,1])
    ...
    train_station_obj_roof = Entity(model = 'quad', position = (102.5,41.6, -0.17), scale = (17, 8.5, 0), texture = train_station_texture, tileset_size = [1,2], tile_coordinate = [0,1])
