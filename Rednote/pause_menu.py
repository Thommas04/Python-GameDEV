...
class PauseMenu(Entity):
    ...
    def __init__(self, language_file, main_menu):
        global filters
        ...
        self.resume_txt = Text(text="", rotation = (0, 0, -6), position = [-2, 0, -0.01], origin=(0,0),color=color.black, parent=camera.ui, font='fonts/CHINESER.TTF', scale = 2.1)
        self.map_txt = Text(text="", rotation=(0, 0, -6), position = [-2, -0.08, -0.01], origin=(0,0),color=color.black, parent=camera.ui, font='fonts/CHINESER.TTF', scale=2.1)
        self.story_txt = Text(text="", rotation=(0, 0, -6), position = [-2, -0.16, -0.01], origin=(0,0),color=color.black, parent=camera.ui, font='fonts/CHINESER.TTF', scale=2.1)
        self.help_txt = Text(text="", rotation=(0, 0, -6), position = [-2, -0.24, -0.01], origin=(0,0),color=color.black, parent=camera.ui,font='fonts/CHINESER.TTF', scale=2.1)
        self.settings_txt = Text(text="", rotation=(0, 0, -6), position = [-2, -0.32, -0.01], origin=(0,0),color=color.black, parent=camera.ui,font='fonts/CHINESER.TTF', scale=2.1)
        self.quit_txt = Text(text="", rotation=(0, 0, -6), position = [-2, -0.4, -0.01], origin=(0,0),color=color.black, parent=camera.ui, font='fonts/CHINESER.TTF', scale=2.1)

        self.resume_click = Entity(alpha = 0, rotation = (0, 0, -6), scale=(0, 0.065, 0), origin=(0,0), position = self.resume_txt.position, model='quad', collider='box', parent=camera.ui, on_click=Func(PauseMenu.resume, self), on_mouse_enter=Func(PauseMenu.on_hover, self, self.resume_txt), on_mouse_exit=Func(PauseMenu.on_leave, self, self.resume_txt))
        self.map_click = Entity(alpha = 0, rotation=(0, 0, -6), scale=(0.2, 0.065, 0), origin=(0, 0), position=self.map_txt.position, model='quad', collider='box', parent=camera.ui, on_click=Func(PauseMenu.open_map, self), on_mouse_enter=Func(PauseMenu.on_hover, self, self.map_txt), on_mouse_exit=Func(PauseMenu.on_leave, self, self.map_txt))
        self.story_click = Entity(alpha = 0, rotation=(0, 0, -6), scale=(0.2, 0.065, 0), origin=(0, 0), position=self.story_txt.position, model='quad', collider='box', parent=camera.ui, on_click=Func(PauseMenu.open_story, self), on_mouse_enter=Func(PauseMenu.on_hover, self, self.story_txt), on_mouse_exit=Func(PauseMenu.on_leave, self, self.story_txt))
        self.help_click = Entity(alpha = 0, rotation=(0, 0, -6), scale=(0.2, 0.065, 0), origin=(0, 0), position=self.help_txt.position, model='quad', collider='box', parent=camera.ui, on_click=Func(PauseMenu.open_help, self), on_mouse_enter=Func(PauseMenu.on_hover, self, self.help_txt), on_mouse_exit=Func(PauseMenu.on_leave, self, self.help_txt))
        self.settings_click = Entity(alpha = 0, rotation=(0, 0, -6), scale=(0.2, 0.065, 0), origin=(0, 0), position=self.settings_txt.position, model='quad', collider='box', parent=camera.ui, on_click=Func(PauseMenu.open_settings, self), on_mouse_enter=Func(PauseMenu.on_hover, self, self.settings_txt), on_mouse_exit=Func(PauseMenu.on_leave, self, self.settings_txt))
        self.quit_click = Entity(alpha = 0, rotation=(0, 0, -6), scale=(0.2, 0.065, 0), origin=(0, 0), position=self.quit_txt.position, model='quad', collider='box', parent=camera.ui, on_click=Func(PauseMenu.open_quit, self), on_mouse_enter=Func(PauseMenu.on_hover, self, self.quit_txt), on_mouse_exit=Func(PauseMenu.on_leave, self, self.quit_txt))
